...
export interface Clinic extends ClinicShort { cnpj: string; descricao?: string; telefone: string; email: string; ativo: boolean; totalProfissionais: number; createdAt: string; updatedAt: string; }
